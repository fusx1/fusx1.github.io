...
* 用户签到获取积分
    ...
    * 我的博文[[大话程序猿眼里的高并发](https://fusx1.github.io/2018/09/09/high-concurrency-scheme/)]有相关的处理方案。
...
* 其他业务
    ...
    * 我的博文[[大话Redis进阶](https://fusx1.github.io/2017/06/01/Redis_up/)]对更新缓存问题和推荐方案的分享。
